      ...
      <section className="hero bg-cover bg-center relative">
        ...
        <div className="container mx-auto py-16 text-center relative z-10">
          ...
          <p className="text-lg text-white mb-8">
            Welcome to Benarfa's Blog, your ultimate destination for all
            things tech. Dive into the world of cutting-edge innovations,
            insightful tech news, and practical guides that will empower you to
            harness the full potential of technology. From the latest gadgets
            and breakthrough advancements to expert analysis and actionable
            tips, we're here to fuel your passion for all things digital.
          </p>
          <Link
            to="/posts"
