...
// }, [])
  ...
  return (
    ...
    <div class='main'>
{/* {posts.map(post=>(
<div key={post.id} class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{post.descreption.substring(0,100)}...</p>
